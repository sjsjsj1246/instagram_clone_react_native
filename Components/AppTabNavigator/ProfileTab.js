...
renderSectionTwo = () => {
    return this.state.blogs.map(blog => (
        <CardComponent data={ blog } key={ blog.uri }/>
    ));
}
...
componentDidMount() {
  ...
  //         <View style={{flexDirection:'row', paddingTop:10}}>
  //           <View style={{flex:1, alignItems:'center'}}>
  //             <Image source={{ uri: 'https://avatars2.githubusercontent.com/u/24623403?s=460&u=3be547107d6fe5378f1fc91368006cbbdde0653e&v=4' }}
  //                     style={{width:75, height:75, borderRadius:37.5}}/>
  //           </View>
  //           <View style={{flex:3}}>
  //             <View style={{flexDirection:'row', justifyContent:'space-around'}}>
  ...
  //         </View>
  //         <View style={{paddingHorizontal:10, paddingVertical:10}}>
  //           <Text style={{fontWeight:'bold'}}>Inseo</Text>
  //           <Text>Stay hungry, Stay foolish</Text>
  //           <Text>https://github.com/sjsjsj1246</Text>
  //         </View>
  //         <View style={{ flexDirection: 'row', justifyContent:'space-around', borderTopWidth:1,borderTopColor:'#eae5e5' }}>
  //         <Button transparent>
  //             <Icon name='ios-apps' />
